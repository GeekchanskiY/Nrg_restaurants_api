...
from .views import get_all_restaurants, post_restaurant_review,\
    get_restaurant_reviews, get_all_news, get_all_news_exclude, get_all_dish_restaurant_data, get_news_by_id,\
    get_all_dish_set_restaurant_data
...
urlpatterns = [
    ...
    path('restaurant/<int:pk>/dish_sets', get_all_dish_set_restaurant_data, name="get_all_restaurant dish sets"),
    ...
    path('news/get/<int:pk>', get_news_by_id, name="get_news_by_id")
]
